...
final class BookmarkTableViewCell: UITableViewCell {
    ...
    func setData(_ medicineName: String, _ medicineImage: String, _ className: String, _ etcOtcName: String) {
        let medicineImageURL = URL(string: medicineImage)
        ...
        etcOtcNameLabel.text = etcOtcName
    }
}
